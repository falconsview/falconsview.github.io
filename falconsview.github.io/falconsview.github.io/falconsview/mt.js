...
var mtCookieDomain = ".secureconsulting.net";
var mtCookiePath = "/";
...
(function () {
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='http://secureconsulting.net/mt-static/images/indicator.white.gif' alt='Loading' />";
  ...
  function _updateComments() {
    ...
    cacheKey = [direction, entryID, commentsPerPage, offset]
        ...
        .replace(/[^a-zA-Z0-9-]/g, '');
    jsonUrl  = [
        "http://secureconsulting.net/mt/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'http://secureconsulting.net/mt/mt-comments.cgi?__mode=userinfo&blog_id=12&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
        (document.getElementsByTagName('head'))[0].appendChild(script);
    }
}
...
function mtVerifySession(cb) {
    ...
    var ts = new Date().getTime();
    var u = mtGetUser();
    script.src = 'http://secureconsulting.net/mt/mt-comments.cgi?__mode=verify_session&blog_id=12&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
    (document.getElementsByTagName('head'))[0].appendChild(script);
}
...
function mtSignIn() {
    ...
    var url = 'http://secureconsulting.net/mt/mt-comments.cgi?__mode=login&blog_id=12';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=http%3A%2F%2Fsecureconsulting.net%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'http://secureconsulting.net/mt/mt-comments.cgi?__mode=handle_sign_in&static=0&logout=1&blog_id=12';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
