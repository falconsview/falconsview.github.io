...
var $iframe=getIframe();$iframe.attr('src',href);$modal.find('.modal-content').append($iframe);var $bsmodal=new bootstrap.Modal($modal.get(0),getModalOptions(opts));$bsmodal.show();}
